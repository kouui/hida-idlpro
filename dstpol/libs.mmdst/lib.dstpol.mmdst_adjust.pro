...
;  2022.02.15      k.i.    sdata, pdata  -> create_struct
;  2022.04.04      u.k.,k.i.    anan keyword in mmdst_adjust
;------------------------------------------------------------------------
...
print, '[debug mmdst_adjust] sdata.s4d  : '
help, sdata.s4d
print, '[debug mmdst_adjust] conf_symfit  : '
help, conf_symfit
...
;}
sdata = create_struct( $;{symfit_data, $ ; 
	's4d', sseq, $        ; fltarr, (nx,ny,ns,nf)
	'dst', dstseq, $      ; uintarr, (3,11nf)
	'wl',  wl $          ; wavelength array
	)
;sdata.s4d = reform(sdata.s4d,ss[1],ss[2],ss[3],1)
