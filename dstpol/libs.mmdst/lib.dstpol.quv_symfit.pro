...
;; s4, (nx, ny, 4, nseq)
;; dst3, (3, 11, nseq)
FUNCTION MPFIT_PARDST, conf_symfit, s4, dst3, parinit, parinfo, err, weight, niter=niter, quiet=quiet, perror=perror
    common symfit, spils, spics, dst3c
    dst3c = dst3
    ss = size(s4)
    ...
    ret = mpfitfun('MODEL_PARDST',0,targets,errs,parinit,weight=weights,errmsg=errmsg, $
			quiet=quiet,maxiter=niter,niter=k,yfit=sfit,bestnorm=eval1,parinfo=parinfo,perror=perror)
	print,ret
	print,perror
