...
for kk=0,1 do begin
    ...
    for i=0,nf-1 do begin
        ...
        endelse
        if kk eq 0 then $
        if curve[0,i] lt 6E3 then count += 1
    endfor
...
plot, dateob22[*,1]-dateob22[*,0], charsize=charsize, color=colors[0],xr=xr,xtitle='# dataset', ytitle='dateob2 time difference [sec]', psym=2
